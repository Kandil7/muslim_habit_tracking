...
class _AddHabitPageState extends State<AddHabitPage> {
  ...
  final List<Map<String, dynamic>> _habitTypes = [
    {'value': AppConstants.prayerHabit, 'label': 'Prayer', 'icon': Icons.mosque},
    {'value': AppConstants.quranHabit, 'label': 'Quran', 'icon': Icons.menu_book},
    {'value': AppConstants.fastingHabit, 'label': 'Fasting', 'icon': Icons.no_food},
    {'value': AppConstants.dhikrHabit, 'label': 'Dhikr', 'icon': Icons.repeat},
    {'value': AppConstants.charityHabit, 'label': 'Charity', 'icon': Icons.volunteer_activism},
    {'value': AppConstants.customHabit, 'label': 'Custom', 'icon': Icons.add_task},
  ];
  ...
  Widget _buildColorSelector() {
    return Wrap(
      spacing: 12,
      runSpacing: 12,
      children: _habitColors.map((colorData) {
