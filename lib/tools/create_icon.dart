...
// Run this script with: flutter run -t lib/tools/create_icon.dart
...
Future<void> main() async {
  ...
  final bgPaint =
      Paint()
        ..color = const Color(
          0xFF4CAF50,
        ) // Green color matching AppColors.primary
  ...
  canvasFg.drawCircle(Offset(size / 2, size / 2), size * 0.35, circlePaint);
  ...
  // Using debugPrint instead of print for logging
  debugPrint('App icons generated successfully!');
  debugPrint('Full icon: ${file.path}');
  debugPrint('Foreground icon: ${fileFg.path}');
